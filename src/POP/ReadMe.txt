========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : POP
========================================================================


AppWizard が生成した POP には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには POP を構成している各ファイルの概要説明が含まれています。
...
POP.h
    ...
    みます） をインクルードし、また CPOPApp アプリケーションクラスを宣
    言します。

POP.cpp
    このファイルは CPOPApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\POP.ico
    ...
    ルです。このアイコンはリソース ファイル POP.rc によってインクルード
    されます。
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、POP.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////
...
POPDoc.h, POPDoc.cpp - ドキュメント
    これらのファイルは CPOPDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CPOPDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

POPView.h, POPView.cpp - ビュー
    これらのファイルは CPOPView クラスを含みます。
    CPOPView オブジェクトは CPOPDoc オブジェクトを表示するために
    使います。
res\POPDoc.ico
    このファイルは CPOPDoc クラスの MDI 子ウィンドウ用アイコンとして使
    われるアイコンファイルです。このアイコンはリソースファイル POP.rc
    によってインクルードされます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) POP.pch 
